...
cover: "/images/posts/visualizing-bubble-sort-with-html-canvas/cover.jpg"
coverAlt: "bubbles"
---
...
<Gist user="galelmalah" id="66b49f69f9b1346eb709b5088bacb895" />

Cool. Now, we will write a simple implementation of the bubble sort algorithm.

<Gist user="galElmalah" id="9b6c55c50ffcb3f5cb4d9c5ba5cc3c6e" />

Next, we'll get our canvas and create a context.

<Gist user="galElmalah" id="5fc668e90e90abe41c0373573495dca1" />
...
<Gist user="galElmalah" id="43c6bf1ae60edbce4b9274b2c4ab8fab" />

---

Let's test that everything is working as expected, by drawing our shuffled array.

<Gist user="galElmalah" id="77c2cecf46a4161baca35af32076808a" />
...
<Gist user="galElmalah" id="a44353e93c59bbcee545658d34b4d481" />
...
<Gist user="galElmalah" id="f2c6708d5ecbd3f58edf42a0bf0fd84f" />
...
<Gist user="galElmalah" id="1a659b2fd9981116360215305cfa3d71" />

We seem to have all of the parts needed in order to visualize this nifty little thing!
Let's give it a try.

<Gist user="galElmalah" id="5fdfc9cc26336e16aea346032a544044" />
...
<Gist user="galElmalah" id="b71096146695cea31ec814c3fed18b6c" />
...
<Gist user="galElmalah" id="a227a2b12557d4c799adfc2a57e4a422" />
